...
import { Mail, Lock, User, Film, ArrowRight, Loader2, AlertCircle, Eye, EyeOff } from "lucide-react";
	...
	return (
		<div className="glass-panel p-8 md:p-12 rounded-2xl shadow-[0_8px_32px_rgba(0,0,0,0.5)] border border-primary/20 w-full relative overflow-hidden">
			...
			<div className="relative z-10 flex flex-col items-center mb-6">
				...
				<p className="text-muted-foreground text-sm text-center">Join SheryCinema to track your favorite movies and shows.</p>
			</div>
